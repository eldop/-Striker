...
class Menu(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        self.image = pygame.Surface((440, 120))
        ...
        ramka = pygame.transform.scale(ramka, (440, 120))
        ...
        turelimage4 = pygame.image.load('turel4.png')
        turelimage4 = pygame.transform.scale(turelimage4, (80, 80))
        ramka.fill((255,255,255))
        ...
        self.image.blit(turelimage4, (320, 20))
